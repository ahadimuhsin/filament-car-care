...
@section("content")
<div class="bg-[#270738] absolute top-0 max-w-[640px] w-full mx-auto rounded-b-[50px] h-[472px]">
            ...
            <div id="Service" class="flex flex-col gap-2">
                <div class="flex items-center w-full gap-[10px] bg-white justify-between">
                    ...
                    <p class="rounded-full p-[6px_10px] bg-[#41BE64] w-fit font-bold text-xs leading-[18px] text-white">
                        SUCCESS</p>
                    @else
                    <p class="rounded-full p-[6px_10px] bg-[#FFCE51] w-fit font-bold text-xs leading-[18px] text-white">
                        PENDING</p>
                    @endif
        ...
        <div class="flex flex-col w-full rounded-2xl border border-[#E9E8ED] p-4 gap-4 bg-white">
            <div id="Location" class="flex flex-col gap-2">
                ...
                <div class="flex items-center w-full gap-[10px] bg-white">
                    <div class="w-[80px] h-[60px] flex shrink-0 rounded-xl overflow-hidden">
                        <img src="{{ asset("storage/".$details->store_details->thumbnail ) }}" class="w-full h-full
            ...
            <div id="Service" class="flex flex-col gap-2">
                ...
                <div class="flex items-center w-full gap-[10px] bg-white justify-between">
                    <div class="flex items-center gap-[10px]">
                        <div class="w-[60px] h-[60px] flex shrink-0">
                            <img src="{{ asset("storage/".$details->service_details->icon) }}" alt="icon">
                        </div>
                        <div class="flex flex-col h-fit">
            ...
            <div id="Time-details" class="flex flex-col gap-[10px]">
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">{{ date("H:i", strtotime($details->time_at)) }} WIB</p>
                </div>
                <div class="flex items-center justify-between">
                    <p class="text-sm leading-[21px]">Date At</p>
                    <p class="font-semibold">{{ date("d F Y", strtotime($details->started_at)) }}</p>
                </div>
            </div>
            <hr class="border-[#E9E8ED]">
            <div id="Price-details" class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p class="font-semibold">Rp {{ number_format($booking_fee, 0, '.', '.') }}</p>
                </div>
                <div class="flex items-center justify-between">
                    <p class="text-sm leading-[21px]">PPN 11%</p>
                    <p class="font-semibold">Rp {{ number_format($total_ppn, 0, '.', '.') }}</p>
                </div>
                <div class="flex items-center justify-between">
