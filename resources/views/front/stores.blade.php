...
<div id="Top-nav" class="flex items-center justify-between px-4 pt-5">
    ...
    <div class="flex flex-col w-fit text-center">
        ...
        <p class="text-sm leading-[21px] text-[#909DBF]">{{ $cityName }}, {{ count($stores) }} Stores</p>
    </div>
...
<section id="Store-list" class="flex flex-col gap-6 px-4 mt-[30px]">
    ...
    <a href="{{ route("front.detail", $store->slug) }}" class="card">
        <div
            ...
            <div class="w-full h-[120px] flex shrink-0 overflow-hidden relative">
                <img src="{{ asset("storage/".$store->thumbnail) }}" class="w-full h-full object-cover"
                alt="thumbnail">
                @if ($store->is_open == 1)
                <p
            ...
            <div class="flex items-center justify-between gap-4 px-4">
                <div class="title flex flex-col gap-[6px]">
                    ...
                    <div class="flex items-center gap-[2px]">
                        ...
                        <p class="text-sm leading-[21px] text-[#909DBF]">{{ substr($store->address, 0, 20) }}...</p>
                    </div>
                </div>
